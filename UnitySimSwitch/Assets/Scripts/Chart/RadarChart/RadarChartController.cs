...
public class RadarChartController : MonoBehaviour
{
    ...
    private void Start()
    {
        foreach (UIRadarChart uiRadarChart in uiRadarCharts)
        {
            ...
            {
                case 3:
                    InitializeStatsWithEnum(stats, typeof(RadarChartEnums.RadarChart3Edges));
                    break;
                case 5:
                    InitializeStatsWithEnum(stats, typeof(RadarChartEnums.RadarChart5Edges));
                    break;
                case 9:
                    InitializeStatsWithEnum(stats, typeof(RadarChartEnums.RadarChart9Edges));
                    break;
                default:
    ...
    private RadarChartEnums.NumberOfEdges GetNumberOfEdgesForRadarChart(UIRadarChart radarChart)
    {
